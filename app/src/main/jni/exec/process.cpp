...
JNIEXPORT void JNICALL Java_com_romide_terminal_Exec_sendSignal(JNIEnv *env, jobject clazz,
    jint procId, jint signal)
{
    kill(procId, signal);
}

JNIEXPORT jint JNICALL Java_com_romide_terminal_Exec_waitFor(JNIEnv *env, jclass clazz, jint procId) {
    int status;
...
JNIEXPORT jint JNICALL Java_com_romide_terminal_Exec_createSubprocessInternal(JNIEnv *env, jclass clazz,
